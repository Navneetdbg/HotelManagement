...
using HotelManegementSystem.Models;
using HmsEntity;
using HmsServices;
...
namespace HotelManegementSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(HMSUserManager userManager, UsersSignInManager signInManager , HmsRoleManeger roleManeger)
        {
            UserManager = userManager;
            SignInManager = signInManager;
            RoleManager = roleManeger;
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var roles = await RoleManager.FindByNameAsync("Users");
                if (result.Succeeded)
                {
                    await UserManager.AddToRoleAsync(user.Id, roles.Name);
